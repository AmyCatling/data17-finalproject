...
def almighty_method():
    ...
    loader1 = LoadData(load_choice='academy', df=transformer1.academy_df)
    loader2 = LoadData(load_choice='talent', df=transformer2.talent_df)
    loader3 = LoadData(load_choice='applicant', df=transformer3.applicant_df)
    loader4 = LoadData(load_choice='sparta_day', df=transformer4.sparta_day_df)
